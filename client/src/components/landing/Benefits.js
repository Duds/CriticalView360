                ...
                <CardContent>
                  ...
                  <Box mb={2}>
                    <Typography variant="body1" color="textSecondary">
                      Our user-friendly interface lets you identify and
                      categorize risks effortlessly, making safety more
            ...
            <Grid item xs={12} md={4}>
              <Card>
                ...
                <CardContent>
                  ...
                  <Box mb={2}>
                    <Typography variant="body1" color="textSecondary">
                      With our robust reporting functionalities, you can easily
                      track your risk management performance and demonstrate
                      compliance.
                    </Typography>
                  </Box>
                </CardContent>
            ...
            <Grid item xs={12} md={4}>
              <Card>
                ...
                <CardContent>
                  ...
                  <Box mb={2}>
                    <Typography variant="body1" color="textSecondary">
                      Our application promotes team collaboration, enabling you
                      to work together effectively for comprehensive risk
                      management.
                    </Typography>
                  </Box>
                </CardContent>
